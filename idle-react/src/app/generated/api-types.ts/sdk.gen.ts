...
/**
 * Get the first active survey the player has not completed
 */
export const getSurveysActive = <ThrowOnError extends boolean = false>(options?: Options<GetSurveysActiveData, ThrowOnError>) => (options?.client ?? client).get<GetSurveysActiveResponses, GetSurveysActiveErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'better-auth.session_token',
            type: 'apiKey'
...
/**
 * Submit a survey answer and receive the configured reward
 */
export const postSurveysAnswer = <ThrowOnError extends boolean = false>(options: Options<PostSurveysAnswerData, ThrowOnError>) => (options.client ?? client).post<PostSurveysAnswerResponses, PostSurveysAnswerErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'better-auth.session_token',
            type: 'apiKey'
...
/**
 * Get the player's last 50 finalized tournament results
 */
export const getTournamentHistory = <ThrowOnError extends boolean = false>(options?: Options<GetTournamentHistoryData, ThrowOnError>) => (options?.client ?? client).get<GetTournamentHistoryResponses, GetTournamentHistoryErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'better-auth.session_token',
            type: 'apiKey'
...
/**
 * Spend idle and real time to increase player level by one
 */
export const postShopUpgradeLevel = <ThrowOnError extends boolean = false>(options?: Options<PostShopUpgradeLevelData, ThrowOnError>) => (options?.client ?? client).post<PostShopUpgradeLevelResponses, PostShopUpgradeLevelErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'better-auth.session_token',
            type: 'apiKey'
