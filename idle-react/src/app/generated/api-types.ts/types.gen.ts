...
export type ShopPurchaseResponse = PlayerState & {
    purchase: {
        upgradeType: 'seconds_multiplier' | 'another_seconds_multiplier' | 'restraint' | 'luck' | 'extra_realtime_wait' | 'collect_gem_time_boost' | 'idle_refund' | 'real_refund' | 'level_bonus';
        quantity: number;
        totalCost: number;
    };
};
