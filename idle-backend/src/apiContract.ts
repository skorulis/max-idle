...
const leaderboardResponseSchema = registry.register(
  "LeaderboardResponse",
  z.object({
    type: z.enum(["current", "collected", "collected_real", "level", "max_multiplier", "time_gems"]),
...
registry.registerPath({
  ...
  request: {
    query: z.object({
      type: z.enum(["current", "collected", "collected_real", "level", "max_multiplier", "time_gems"]).optional()
    })
  },
  responses: {
    200: {
