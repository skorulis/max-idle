...
export const SECONDS_MULTIPLIER_SHOP_UPGRADE: ShopUpgradeDefinition = defineShopUpgrade({
  ...
  levels: [
    ...
    { cost: 120, value: 1.2 },
    { cost: 300, value: 1.3 },
    { cost: 30 * 60, value: 1.4 },
    { cost: SECONDS_PER_HOUR, value: 1.5 },
    { cost: 2 * SECONDS_PER_HOUR, value: 1.6 },
    { cost: 5 * SECONDS_PER_HOUR, value: 1.7 },
    { cost: 10 * SECONDS_PER_HOUR, value: 1.8 },
    { cost: 21 * SECONDS_PER_HOUR, value: 1.9 },
    { cost: 30 * SECONDS_PER_HOUR, value: 2.0 },
    { cost: 6 * SECONDS_PER_WEEK, value: 2.1 },
    { cost: 10 * SECONDS_PER_WEEK, value: 2.2 },
    { cost: 15 * SECONDS_PER_WEEK, value: 2.3 },
    { cost: 20 * SECONDS_PER_WEEK, value: 2.4 },
    { cost: 30 * SECONDS_PER_WEEK, value: 2.5 },
  ],
