...
export const SECONDS_MULTIPLIER_SHOP_UPGRADE: ShopUpgradeDefinition = defineShopUpgrade({
  ...
  levels: [
    ...
    { cost: 24 * SECONDS_PER_HOUR, value: 1.9 },
    { cost: 48 * SECONDS_PER_HOUR, value: 2.0 },
    { cost: 1 * SECONDS_PER_WEEK, value: 2.1 },
    { cost: 2 * SECONDS_PER_WEEK, value: 2.2 },
    { cost: 4 * SECONDS_PER_WEEK, value: 2.3 },
    { cost: 7 * SECONDS_PER_WEEK, value: 2.4 },
    { cost: 10 * SECONDS_PER_WEEK, value: 2.5 },
  ],
